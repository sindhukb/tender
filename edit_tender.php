			   ...
			   <!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs" >
					<ol class="nav navbar-nav nav_1">
						...
						<li><a href="products.html">Delete Tender</a></li>
						<li><a href="products.html">Tender History</a></li>
						<li><a href="products.html">Successful Tender</a></li>					<!--	<li><a href="products.html">Tranquilizers</a></li>
				...
				<div class="module form-module">
				  ...
				  <div class="form">
					...
					<form action="#" method="post">
					  Tender number<input type="text" name="name" placeholder="name" required=" " value="name">
					 Component Name <input type="text" name="Component_name" placeholder="Component Name" required=" " value="Component_name">
					 composition<input type="text" name="composition" placeholder="composition" required=" " value="composition">
					 Expected Rate <input type="text" name="rate" placeholder="Rate" required=" " value="rate">
					 Quantity<input type="text" name="quantity" placeholder="Quantity" required=" " value="quantity">
					 Date Of Delivery<br><input type="Date" name="DOD" placeholder="Date of delivery" required=" " value="DOD"><br><br>
					 Tender Start Date<br><input type="Date" name="TSD" placeholder="Start Date" required=" " value="TSD"><br><br>
					 Tender End Date<br><input type="Date" name="TED" placeholder="End Date" required=" " value="End Date"><br><br>
